...
CommonTranslationTable = {
	...
	["GeneralA"] = "Chủ tướng",
	["GeneralB"] = "Phó tướng",
	["surrender:yes"] = "Có thể lập tức đầu hàng",
	["@dummy-slash"] = "Hãy sử dụng [Sát] lên mục tiêu",
	["@dummy-slash2"] = "Chọn %src sử dụng [Sát] lên mục tiêu",
	...
	["aoe"] = "Hiệu quả diện rộng",
	["single_target_trick"] = "Công cụ đơn mục tiêu",
	["multiple_target_trick"] = "Công cụ đa mục tiêu",
	["delayed_trick"] = "Công cụ thời gian",
	...
	["#TriggerSkill"] = "%from phát động [%arg]",
	["#TriggerSkillEffect"] = "%from phát động [%arg] có hiệu quả",
	...
	["#Recover"] = "%from khôi phục %arg máu",
	...
	["#LoseHp"] = "%from bị mất %arg máu",
	["#LoseMaxHp"] = "%from bị mất %arg giới hạn máu",
	["#GainMaxHp"] = "%from nhận được %arg giới hạn máu",
	["#GetHp"] = "%from hiện tại có %arg máu, giới hạn máu là %arg2",
	["#ChangeKingdom"] = "%from buộc %to chuyển thế lực %arg sang %arg2",
	["#AnalepticBuff"] = "%from sử dụng [<font color=\"yellow\"><b>Tửu</b></font>], gây %arg sát thương lên %to tăng thành %arg2 điểm",
	["#GetMark"] = "%from nhận được %arg2 tiêu ký %arg",
	["#LoseMark"] = "%from bị mất %arg2 tiêu ký %arg",
	...
	["#UseLuckCard"] = "%from đã <font color=\"yellow\"><b>Đổi bài</b></font>",
	...
	["MultiTarget"] = "Công cụ đa mục tiêu",
	["DelayedTrick"] = "Công cụ thời gian",
    ...
    ["@tarnsferfieldcard"] = "Chọn 1 lá để di chuyển",
}
